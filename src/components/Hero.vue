                ...
                <div class="lg:py-6">
                    ...
                    <div class="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
                        <button
                            ...
                            <a href="https://wa.me/+5547984024581" target="_blank"><span
                                    class="relative flex items-center justify-center text-white">Hire Me</span></a>
                        </button>
                        <button
                            ...
                            <div
                                ...
                                <a href="src\assets\GovindHede.pdf" download="Tiago-Lauer.pdf"
                ...
                <div class="lg:h-full md:flex">
                    <div
                        ...
                        <div
                            ...
                            <img src="@/assets/profile-photo.jpg" alt="Hero pic" width="500" height="auto"
