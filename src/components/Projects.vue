        ...
        <div class="px-4 xl:pl-16">
            <div class="mb-4 md:flex md:justify-between xl:pr-16">
                ...
                <div class="flex space-x-4 mb-4 mt-5 md:mt-0">
                    <button class="hover:text-primary" v-for="category in ['all', 'web development']" :key="category"
...
const Projects = ref([
    {
        ...
        description: 'The Bravus Sistemas website was developed with a focus on performance, user experience, and scalability. Using HTML, CSS & JavaScript for the frontend and Node.js for the backend, the site provides a responsive, modern interface with fast load times. Bootstrap was implemented for a consistent and clean UI, ensuring responsiveness across devices. Key features include dynamic contact forms (AJAX), a live support chat, and SEO optimizations for better visibility. The design follows WCAG accessibility guidelines to ensure usability for all users.',
    ...
    },
    {
        ...
        description: "The CadastroJS project was developed as a technical test for a job application, showcasing my skills in front-end development and building intuitive user interfaces. The main goal was to create a simple yet functional user registration system, emphasizing clean code and scalability.",
    ...
    },
    {
        ...
        description: 'The Currency Task project was built as an admission test, focusing on real-time currency conversion using Vue.js and Axios for API integration. Deployed on Vercel, it offers fast, responsive performance for desktop and mobile users. The project demonstrates my ability to create efficient, real-world applications in a testing environment.',
